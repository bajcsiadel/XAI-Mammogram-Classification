...
class DenseNet_features(nn.Module):
    ...
    Args:
        ...
        num_init_features (int) - the number of filters
          to learn in the first convolution layer
...
def densenet121_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        state_dict = model_zoo.load_url(
            model_urls["densenet121"], model_dir=PRETRAINED_MODELS_DIR
        )
...
def densenet169_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # to find such keys.
        state_dict = model_zoo.load_url(
            model_urls["densenet169"], model_dir=PRETRAINED_MODELS_DIR
        )
        for key in list(state_dict.keys()):
            """
            example
...
def densenet201_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # to find such keys.
        state_dict = model_zoo.load_url(
            model_urls["densenet201"], model_dir=PRETRAINED_MODELS_DIR
        )
        for key in list(state_dict.keys()):
            """
            example
...
def densenet161_features(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # to find such keys.
        state_dict = model_zoo.load_url(
            model_urls["densenet161"], model_dir=PRETRAINED_MODELS_DIR
        )
        for key in list(state_dict.keys()):
            """
            example
