...
from util.preprocess import mean, preprocess_input_function, std
...
# load the data
from ProtoPNet.config.settings import test_dir, train_dir, train_push_dir
...
log("test set size: {0}".format(len(valid_loader.dataset)))
