...
def push_prototypes(
    ...
    num_classes = prototype_network_parallel.module.n_classes
...
def update_prototypes_on_batch(
    ...
    for j in range(n_prototypes):
        ...
        if class_specific:
            ...
            # if there are no images of the target_class from this batch
        ...
        if batch_min_proto_dist_j < global_min_proto_dist[j]:
            ...
            upsampled_act_img_j = cv2.resize(
                ...
                dsize=(original_img_w, original_img_h),
            ...
            # save the prototype boundary
            # (rectangular boundary of highly activated region)
            ...
            np.save(
                ...
                / f"{logger.file_prefixes.self_activation}-{j}.npy",
                proto_act_img_j,
            )
            ...
            # on original image and save the result
            ...
            # if different from the original (whole) image,
            # save the prototype receptive field as png
            if (
                ######################################################
                rf_img_j.shape[0] != original_img_h
